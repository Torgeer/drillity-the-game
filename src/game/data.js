...
const ITEMS_TRENCHLESS = [
  ...
  it({ id: 'rb-stem-254', name: 'Raise Bore Drill Stem, 254 mm x 1.5 m', category: CAT.raiseStems, slot: 'rod',
    price: 5680, unlockLevel: 52, methods: ['raise-boring'],
    thread: 'raise stem box/pin', material: '34CrNiMo6', duty: 'HD', consumable: true,
    stats: { ropMult: 1.0, wearRate: 0.85, torqueCap: 310, life: 4200 },
    description: 'Solid-wall stem rated for 4200 kN of pull. Each one weighs 340 kg and there are two hundred of them on a deep raise.' }),
  ...
  it({ id: 'rb-reamer-1800-hd', name: 'Raise Bore Reamer Head, 1800 mm HD', category: CAT.raiseReamer, slot: 'head',
    ...
    description: 'Ventilation-shaft sized. Twenty-two cutters, each one replaceable underground, each one a day rate on its own.' }),
