...
MACHINES = ['pd55', 'crawler_th', 'core_rig', 'tunnel_jumbo', 'dth_crawler', 'cfa_rig', 'piling_leader', 'foundation_bg', 'rc_rig', 'cable_percussion', 'oil_derrick', 'hdd_rig', 'longhole_rig', 'raisebore']          # add ids here as they are built
